  ...
  <div class="container marketing mb-5 mt-5 text-dark">
    ...
    <form class="row g-3" action="{{route('thanhtoan.index')}}" method="POST">
      ...
      <div class="form-group col-md-6 row">
        ...
        <div class="col-sm-9">
          <input type="text" readonly class="form-control-plaintext" name="price_tour" value="{{$tour->price}}">
        </div>
      </div>
      <div class="form-group col-md-6 row">
        <label class="col-sm-3 col-form-label"><i class="fas fa-calendar-alt"></i> <strong> Số Ngày:</strong></label>
        <div class="col-sm-9">
          <input type="text" readonly class="form-control-plaintext" name="duration" value="{{$tour->duration}}">
        </div>
      </div>
      <div class="form-group col-md-6 row">
        <label class="col-sm-6 col-form-label"><i class="fas fa-calendar-alt"></i> <strong> Số Điện thoại</strong></label>
        <div class="col-sm-4">
          <input type="text" class="form-control" name="phone">
        </div>
      </div>
      <div class="form-group col-md-3 row">
        <label class="col-sm-6 col-form-label"><i class="fas fa-calendar-alt"></i> <strong> Số người lớn</strong></label>
        <div class="col-sm-4">
          <input type="number" class="form-control" id="staticEmail" name="Nguoilon">
        </div>
      </div>
      <div class="form-group col-md-3 row">
        <label class="col-sm-6 col-form-label"><i class="fas fa-calendar-alt"></i> <strong> Số trẻ em</strong></label>
        <div class="col-sm-4">
      ...
      <div class=" form-group col-12">
        ...
        <select class="form-control" name="price_car">
          ...
          @foreach ($car as $car)
          <option value="{{$car->price}}">{{$car->name}} |  <i>Đơn giá {{$car->price}}</i> </option>
