            ...
            <div class="col-md-4">
                <div class="card-body">
                    ...
                    <p class="card-text m-0"><i class="fas fa-calendar-alt"></i> <strong>Ngày Đi:</strong>
                        ...
                        @endphp</p>
                    <p class="card-text m-0"><i class="fas fa-map-marker-alt"></i> <strong>Nơi Khởi Hành:</strong> </p>
                    <p class="card-text m-0"><i class="fas fa-money-bill-alt"></i> <strong>Giá:</strong>{{ $tour->price }}
                    </p>
                    ...
                    <a href="{{ route('chitiettour.index', ['id' => $tour->id]) }}" type="button"
                        class="btn btn-info text-white">Đặt tour</a>
                </div>
                <div class="mt-5 row">
                    ...
                    @foreach ($TourSame as $TourSame)
                        <div class="card mb-3 p-0 m-0" style="max-width: 100%   ;">
                            <div class="row g-0 col-12">
                                <div class="col-md-4">
                                    <a href="{{ route('chitiettour.index', ['id' => $TourSame->id]) }}"><img
                                            src="{{ $TourSame->feature_image_path }}" class="rounded-start p-0 m-0"
                                            style="width: 100%; height: 100%;"></a>
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h6>{{ $TourSame->name }}</h6>
                                        <a href="{{ route('chitiettour.index', ['id' => $TourSame->id]) }}"
                                            class="text-decoration-none text-dark">
                                            <p class="card-title">{{ $TourSame->description }}</p>
                                        </a>
                                    </div>
                                </div>
                            </div>
